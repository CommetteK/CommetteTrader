...
export declare namespace NFTMinter {
  ...
  export type MetadataStructOutput = [
    ...
    title: string,
    walletAddress: string
  ] & { name: string; title: string; walletAddress: string };
}
...
export interface NFTMinter extends BaseContract {
  ...
  getTokenMetadata: TypedContractMethod<
    [tokenId: BigNumberish],
    [NFTMinter.MetadataStructOutput],
    "view"
  >;
  ...
  mint: TypedContractMethod<
    [_name: string, _title: string, _walletAddress: string, _tokenURI: string],
    [void],
    "nonpayable"
  >;
